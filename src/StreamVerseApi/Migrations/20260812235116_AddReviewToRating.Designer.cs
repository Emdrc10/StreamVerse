...
namespace StreamVerseApi.Migrations
{
    ...
    [Migration("20260812235116_AddReviewToRating")]
    partial class AddReviewToRating
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StreamVerse.Domain.Entities.Favorite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StreamVerse.Domain.Entities.Rating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StreamVerse.Domain.Entities.Favorite", b =>
                {
                    b.HasOne("StreamVerse.Domain.Entities.Movie", "Movie")
                        .WithMany()
                        .HasForeignKey("MovieId");

                    b.HasOne("StreamVerse.Domain.Entities.Serie", "Serie")
                        .WithMany()
                        .HasForeignKey("SerieId");

                    b.HasOne("StreamVerse.Domain.Entities.User", "User")
                        .WithMany()
